...
import 'package:bok_app_flutter/common/jh_common/utils/jh_color_utils.dart';
...
//      _pwdImg = _pwdShow?ImageIcon(AssetImage('assets/images/ic_pwd_close.png')):ImageIcon(AssetImage('assets/images/ic_pwd_open.png')) ;
    ...
    var underlineColor = KColors.dynamicColor(context,
        Theme.of(context).primaryColor, KColors.kFocusedBorderDarkColor);
